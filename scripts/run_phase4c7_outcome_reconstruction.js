...
async function runPhase4C7OutcomeReconstructionSuite() {
  ...
  if (process.env.ARTIFACTS_DIR) {
    ...
    reportPath = path.join(process.env.ARTIFACTS_DIR, "PHASE_4C7_HISTORICAL_OUTCOME_RECONSTRUCTION_REPORT.md");
    ...
    reportPath = path.join("C:\\Users\\DeepJAdhia\\.gemini\\antigravity-ide\\brain\\9d9ad3b6-21ed-4c70-912c-ed9fff2fd196", "PHASE_4C7_HISTORICAL_OUTCOME_RECONSTRUCTION_REPORT.md");
  } else {
    const artifactsDir = path.join(process.cwd(), "artifacts");
    if (!fs.existsSync(artifactsDir)) fs.mkdirSync(artifactsDir, { recursive: true });
    reportPath = path.join(artifactsDir, "PHASE_4C7_HISTORICAL_OUTCOME_RECONSTRUCTION_REPORT.md");
  }
